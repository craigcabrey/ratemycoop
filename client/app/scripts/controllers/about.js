...
angular.module('ratemycoopApp')
  .controller('AboutCtrl', function ($scope, common) {
    ...
    var lexi = new Contributor("Lexi Rich", "Idea Packager", "alexislrich@gmail.com", "Packaging Science", "");
    var joe = new Contributor("Joseph DeSimpliciis", "Developer", "jcd4790@rit.edu", se, "http://jcdesimp.com");

    function Contributor(name, role, email, major, link) {
      this.name = name;
      this.role = role;
      this.email = email;
      this.major = major;
